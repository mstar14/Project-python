...
print("\n---------------------------------")
print("-------------จัดทำโดย-------------")
print("นางสาวณัฐณิชา  เวียงเงิน  623050050-3")
print("นางสาวนัฐติกา อนุญาหงษ์  623050278-3")
print("นางสาวศศินิภา มูลมัง      623050415-9")
...
def MainMenu():
    ...
    if select == 1: 
        ...
        P("------------ ตัวอย่าง ------------")
        P("623050050-3:นางสาวณัฐณิชา เวียงเงิน\n")
